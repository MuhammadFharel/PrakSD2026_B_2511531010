...
public class DaftarKataDriver_2511531010 {
	 public static void main(String[] args) {
		 DaftarKata_2511531010 al = new DaftarKata_2511531010();

	      // Menambah elemen (akhir)
	      al.tambah_2511531010("Kami");
	      al.tambah_2511531010("Informatika");

	      // Menyisipkan elemen pada indeks 1
	      al.tambahPada_2511531010(1, "Mahasiswa");

	      // Cetak isi awal
	      System.out.println("Awal           : " + al);

	      // Mengubah elemen (index 1)
	      al.ubahElemen_2511531010(1, "Departemen");
	      System.out.println("Setelah Ubah: " + al);

	      // Menghapus elemen (hapus index 0)
	      String terhapus = al.hapusElement_2511531010(0);
