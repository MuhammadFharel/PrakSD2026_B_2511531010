...
public class BubbleSortGUI_2511531010 extends JFrame {
    ...
    private int i_1010 = 0;
    private int j_1010 = 0;
     ...
     * Create the frame.
     */
    public BubbleSortGUI_2511531010() {
    ...
    private void setArrayFromInput() {
        ...
        for (int k_1010 = 0; k_1010 < array_1010.length; k_1010++) {
            ...
            labelArray_1010[k_1010].setOpaque(true);
            labelArray_1010[k_1010].setBackground(Color.WHITE);
    ...
    private void performStep() {
        if (!sorting_1010 || i_1010 >= array_1010.length - 1) {
            sorting_1010 = false;
            stepButton_1010.setEnabled(false);
        ...
        labelArray_1010[j_1010 + 1].setBackground(Color.CYAN);
        if (array_1010[j_1010] > array_1010[j_1010 + 1]) {
            // Swap
            int temp_1010 = array_1010[j_1010];
            array_1010[j_1010] = array_1010[j_1010 + 1];
            array_1010[j_1010 + 1] = temp_1010;
            labelArray_1010[j_1010].setBackground(Color.RED);
            labelArray_1010[j_1010 + 1].setBackground(Color.RED);
            stepLog_1010.append("Langkah ").append(stepCount_1010).append(": Menukar elemen ke-")
                    .append(j_1010).append(" (").append(array_1010[j_1010 + 1]).append(") dengan elemen ke-")
                    .append(j_1010 + 1).append(" (").append(array_1010[j_1010]).append(")\n");
        } else {
            stepLog_1010.append("Langkah ").append(stepCount_1010).append(": Tidak ada pertukaran antara ke-")
                    .append(j_1010).append(" (").append(array_1010[j_1010]).append(") dan ke-").append(j_1010 + 1).append(" (").append(array_1010[j_1010 + 1]).append(")\n");
        }
        stepLog_1010.append("Hasil: ").append(arrayToString(array_1010)).append("\n\n");
        stepArea_1010.append(stepLog_1010.toString());
        updateLabels();
        j_1010++;
        if (j_1010 >= array_1010.length - i_1010 - 1) {
            j_1010 = 0;
            i_1010++;
        }
        stepCount_1010++;
        if (i_1010 >= array_1010.length - 1) {
            sorting_1010 = false;
            stepButton_1010.setEnabled(false);
            JOptionPane.showMessageDialog(this, "Sorting selesai!");
        }
    ...
    private String arrayToString(int[] arr_1010) {
        ...
        for (int k_1010 = 0; k_1010 < arr_1010.length; k_1010++) {
            ...
            if (k_1010 < arr_1010.length - 1) sb_1010.append(", ");
        }
    ...
    public static void main(String[] args_1010) {
        SwingUtilities.invokeLater(() -> {
            BubbleSortGUI_2511531010 gui_1010 = new BubbleSortGUI_2511531010();
